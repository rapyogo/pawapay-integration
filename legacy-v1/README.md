> ARCHIVE API V1 : exemples historiques non validés par la mise à jour v2. Lire le [skill actuel](../SKILL.md) pour les nouvelles intégrations.
...
```
INSTRUCTIONS-V1.md                          # instructions principales pour l'agent IA
references/
